...
public interface OLVerificationLibrary {
     ...
     * @param presExpDate Expiration date serialized as RfC3339UTC
     * @param epoch The epoch (corresponding to the PS credential)
     * @return
     */
    OLVerificationLibraryResult verifyOlPsDerivedProof(String token, Map<String, Attribute> revealedAttributes, String nonce, String presExpDate, long epoch);
     ...
     * @return
     */
    OLVerificationLibraryResult verifyOlPsDerivedProofRange(String token, Map<String, Attribute> revealedAttributes, Map<String, RangePredicateToken> rangeTokens, Set<Predicate> rangePredicates, String nonce, String presExpDate, long epoch);
}
