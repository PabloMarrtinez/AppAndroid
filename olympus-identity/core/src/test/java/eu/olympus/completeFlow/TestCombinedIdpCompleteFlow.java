...
public class TestCombinedIdpCompleteFlow extends CommonCompleteTests{
    ...
    public void testCombinedDirect() throws Exception{
        ...
        W3CPresentationVerifier pabcVerifier= new W3CPresentationVerifierOL(verificationLibrary);
    ...
    public void testPestoAndPabcREST() throws Exception{
        ...
        PSCredentialManagement credentialManagementWithoutStorage=new PSCredentialManagement(false, null,60);
