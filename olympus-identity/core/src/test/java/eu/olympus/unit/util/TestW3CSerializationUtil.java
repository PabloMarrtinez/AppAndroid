...
public class TestW3CSerializationUtil {
	...
	public void testGenerateVCredential() throws IOException {
		...
		VerifiableCredential cred=W3CSerializationUtil.generateVCredential(issuance, expiration,attributeMap, null, "AssertionMethod", "proofValueExample", "https://olympus-deployment.eu/example/context", false, null, null, URI.create("did:meta:OL-vIdP"), "verificationMethodExample",generateCredSchema());
	...
	private Object generateCredSchema() {
		...
		String encodingSchemaUrl="https://olympus-project.eu/example/encodingSchema";
		List<CredentialSchema> result= new ArrayList<>(2);
		result.add(new CredentialSchema("OlZkValidationSchema", validationSchemaUrl));
		result.add(new CredentialSchema("OlZkEncodingSchema", encodingSchemaUrl));
		return result;
	}
	...
	public void testGenerateVPresentation() throws IOException {
		...
		VerifiableCredential credWithoutRange=W3CSerializationUtil.generateVCredential(issuance, expiration,attributeMap1, null, "AssertionMethod", "proofValueExample", "https://olympus-deployment.eu/example/context", true, "nonceExample1", null, URI.create("did:meta:OL-vIdP"), "verificationMethodExample",generateCredSchema());
		...
		predicates.add(new Predicate("uri:Height", Operation.GREATERTHANOREQUAL,new Attribute(180)));
		...
		VerifiableCredential credWithRange=W3CSerializationUtil.generateVCredential(issuance, expiration,attributeMap2, predicateMap, "AssertionMethod", "proofValueExample", "https://olympus-deployment.eu/example/context", true, "nonceExample2", ranges, URI.create("did:meta:OL-vIdP"), "verificationMethodExample",generateCredSchema()
        );
	...
	public void testExtractRangeTokens() throws IOException {
		...
		ranges.add(range);
		VerifiableCredential cred=W3CSerializationUtil.generateVCredential(issuance, expiration,attributeMap, null, "AssertionMethod", "proofValueExample", "https://olympus-deployment.eu/example/context", true, null, ranges, URI.create("did:meta:OL-vIdP"), "verificationMethodExample",generateCredSchema()
        );
	...
	public void testExtractRangeTokensFails() throws IOException {
		...
		range.put("upperBoundProofValue", token2.getProofUpperBound().getEncoded());
		ranges.add(range);
		VerifiableCredential cred2=W3CSerializationUtil.generateVCredential(issuance, expiration,attributeMap, null, "AssertionMethod", "proofValueExample", "https://olympus-deployment.eu/example/context", true, null, ranges, URI.create("did:meta:OL-vIdP"), "verificationMethodExample",generateCredSchema()
        );
	...
	public void testSerializePredicateErrors() throws IOException {
		...
		Predicate invalidGE=new Predicate("name",Operation.GREATERTHANOREQUAL,null);
		Predicate invalidLE=new Predicate("name",Operation.GREATERTHANOREQUAL,null);
		Predicate invalidINRANGE=new Predicate("name",Operation.INRANGE,null,new Attribute(2));
		Predicate invalidINRANGEextraValue=new Predicate("name",Operation.GREATERTHANOREQUAL,new Attribute(2),null);
		try{
