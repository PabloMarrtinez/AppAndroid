...
public class InMemoryPestoDatabase implements PestoDatabase{
	...
	public synchronized void addAttribute(String username, String key, Attribute value) {
		//@ALX Why is toLowerCase called here? (We would need to make clear that we use this in storage to make it case insensitive). For example, the InMemoryPestoDatabase in oidc-demo-idp does not have this
